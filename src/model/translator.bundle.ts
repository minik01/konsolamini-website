...
currentLang!.set('common.click-on-element', 'Każdą technologię opatrzyłem subiektywną ocenę znajomości, biorąc pod uwagę różną złożoność technologii. Przykładowo Angular – pomimo codziennej pracy w tym frameworku mam jeszcze sporo do nauki. Dołączam linki do gita, aby łatwiej zobrazować jak wygląda mój kod.');
